...
# Move CleanupAction before ContentView so reference-backed UI state can own it.
...
# Simplify the sidebar expression for the newer type checker.
...
# ViewModifier state is also reference-backed for Swift 6 / SDK 27 helper mutation rules.
