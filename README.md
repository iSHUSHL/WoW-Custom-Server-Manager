...
WoWCC development is intentionally limited to **Vanilla, The Burning Crusade, Wrath of the Lich King, Cataclysm, and Mists of Pandaria**. Vanilla/TBC/WotLK are the first working development group; Cataclysm and MoP are the current active expansion-development focus. Later expansions are not planned.
...
\n**Current source milestone: v1.6.24 — Characters Simplified.** The current Characters workflow intentionally keeps toon status/details and Set Level while removing the unsuccessful AI/inventory/maximizer experiments.\n
